...
/*
    ...
    2. 그러면 오류 뜨는데 알아서 처리할 것
    3. TabletFactory의 고유 method인 upgrade(String model) 메서드를 call2()유형으로 정의하고,
    ...
    9. Factory 클래스의 인스턴스인 factory2 객체를 생성할 것
        ...
        factory2 메서드의 name은 삼성 컴퓨터 공장으로 set 하시오.
