...
public interface Press {
    ...
    /*
        ...
        public final이 생략되어있습니다. 그래서 String 앞에 final을 명시하더라도
        intellij 상에서 불필요하다는 안내가 나옵니다.
    ...
    void popOut() {
        System.out.println("추상 메서드x / 얘는 일반 메서드");
    }
    */
    ...
    // 이미 생성된 Up interface 에 onUP()이라는 추상 메서드를 정의하시오.
