...
public class Array01 {
    public static void main(String[] args) {
        ...
        // 반복문을 활용하여 arr01의 내부 element 들을 콘솔에 출력하시오.
        // 1 2 3 4 5 로 출력될 수 있도록 수정하시오.
        for(int j = 0; j < 5; j++) {                // 5가 하드코딩 되어있음. -> literal을 그대로 썼다.
            System.out.print(arr01[j] + " ");       // j가 어디에 적용되어야하는지 감안할 필요가 있다.
        }

        System.out.println();

        for(int j = 0 ; j < arr01.length; j++) {        // arr01.length 형태로 배열 내부의 데이터 개수가 바뀌더라도 문제 없음
        ...
        // 이상의 모든 것을 종합했을 때,
        // 배열 내부의 방의 개수 / 주소지의 한계값 -1 을 우리가 항상 알고 있는 것은 아니기 때문에
        // element 값을 출력하기 위한 반복문의 한계값을 설정할 때
        // 배열명.length를 쓰는 것을  생활화하자.

        // arr01 내부에 있는 1,2,3,4,5 는 굳이 따지자면 arr01[0], arr01[1], arr01[2], ... , arr01[4]
        // 라는 변수명을 지니고 있다고 볼 수 있습니다.
        ...
        System.out.println();
        // arr02에 현재 21,22 ,...30이 대입 되어 있습니다.
