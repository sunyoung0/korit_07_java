...
public class Method02 {
    ...
    // call4() 유형으로 작성할겁니다. 왜? -> 몇줄짜리 인지 / 어떤 유형의 별찍기인지를 main에서 받을 예정이기 때문에
    public static String getStar(int rows, int option) {
        // 메서드 내에서만 사용하는 지역 변수 (local variable) 선업 및 초기화
        String result = "";
