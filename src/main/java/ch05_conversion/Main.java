...
public class Main {
    public static void main(String[] args) {
        ...
        // 바꾸고 계속 적용해야하는 경우
        char cast3 = 'b';
        int casted3 = cast3;        // 여기서는 (int)로 안쓰였음
        // 대신 위를 보면 변수를 선언할 때의 자료형이 변환되기를 원하는 자료형으로 명시해줌.
        ...
        // 지시 사항 : 다운캐스팅하는 방법을 업캐스팅 방법 #1 , #2를 참고하여 char 형으로 바꾼 후 콘솔창에 원형과 변형을 모두 출력하시오.
        // 다운캐스팅 방법 # 1
        ...
        /*
            현재 40번 코드 라인에서 오류가 발생 하는 것은 정상
            추후 수업에서 더 중요하게 적용되는 개념인데, 업캐스팅의 경우에는 메모리 용량이 커지면 되니까
            ...
            -> 현재는 기본 자료형을 기준으로 예시로 들었지만 나중에는 참조자료형 캐스팅 개념과 연결됨. 아마도 14번챕터
         */
        ...
        /*
            ...
            -> SQL 문에서는 그 와중에 long이 아니라 bigint 라고 씀
