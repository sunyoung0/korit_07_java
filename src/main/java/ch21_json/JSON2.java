...
public class JSON2 {
    ...
    public static void main(String[] args) {
        ...
        // 하나는 한줄로 출력하고
        // 하나는 prettyPrinting 적용시켜서 출력상의 차이를 확인해보기 위해 두개 만들었습니다.
        ...
        System.out.println(jsonUser2);      // gsonBuilder 이라서 prettyPrinting 적용
        ...
        /*
            ...
            즉, toJson()은 overloading 이 이루어졌다고 볼 수 있네요.
            
            그리고 gson 객체에서도 toJson()이 있고 gsonBuilder 에서도 toJson()이 있다는 점 또한 주목할 부분입니다.
            
            그 다음은 json을 Map / Java Object 로 바꾸는 방식도 있습니다.
            근데 String data인 json을 "" 포함해서 쓰는게 너무 귀찮기 때문에
            user1 과 productMap1을 json 으로 바꾼 데이터를 그대로 쓰도록 하겠습니다.

            jsonUser2 를 user2로 바꾸고,
        ...
        /*
            gsonBuilder로 fromJson()을 적용하더라도 콘솔상에서 prettyPrinting은 적용되지 않습니다.
            ...
            그래서 gson.fromJson()이든 gsonBuilder.fromJson()이건 콘솔에 찍히는 결과값은 동일하다고 할 수 있습니다.
         */
        ...
        /*
            ...
            잘 생각해보시면 jsonUser1을 선언할 때 자료형을 String 으로 잡았습니다.
