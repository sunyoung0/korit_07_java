...
/*
    ...
    생성자의 정의 방식
        1. 기본 생성자 : 매개변수가 없는 생성자
            ...
            ClassAMain, CarMain 에서 객체를 생성해봤었습니다. -> 복습필요
            정확하게는 default로 새성된 기본 생성자를 Main 에서 호출해봤다고 볼 수 있습니다.
            호출결과 -> 객체생성
...
public class Constructor {
    ...
    // 기본 생성자는 call1() 유형에 해당할 것이고, 클래스와 동일한 메서드명을 가집니다.
    Constructor() {
    ...
    // 지어 객체를 생성 한 후,
    // System.out.println(constructor3.name);을 입력하여 콘솔에 출력하시오.
