...
/*
    if - else if 문 : if - else 문과 달리 else if 에는 별도의 조건식이 요구됨.
...
public class Condition03 {
    public static void main(String[] args) {
        ...
        final int GOLD_POINT = 80;      // 즉 변함없는 데이터를 사용하고 싶을 때 사용
        final int SILVER_POINT = 60;    // 얘가 변함없는 데이터임을 개발자들이 알아보기 위해
        final int BRONZE_POINT = 40;    // snake case의 대문자로만 작성. 띄어쓰기는 '_' 사용
