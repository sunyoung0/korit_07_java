...
public class ForEachMain {
    ...
    public static void main(String[] args) {
        // List 생성 -> 빈거 생성하고 넣는거 말고 바로 만들겁니다.
        // 즉, 선언 및 초기화 방식
        List<String> fruits = Arrays.asList("사과", "딸기", "블루베리");

        System.out.println(fruits);

        // 여기서 저희는 각 element 를 추출하기 위해서 for 문 / 향상된 for 문을 사용해왔습니다.
        // 과일명 : 사과
        // 과일명 : 딸기
        // 과일명 : 블루베리
        ...
        // 여태까지 저희가 List 등의 Collection 에서 각 element 들을 추출하여 데이터를 가공한다고
        // 가정했을 때 필수적으로 List 내부를 돌아다니는 반복문을 작성해야만 했습니다.

        // 하지만 forEach() 메서드 '내'에 람다식을 작성함으로써
        // 읽을 수만 있다면 가독성 있는 형태로 데이터를 가공할 수 있음을 확인했습니다.

        // 이상의 '메서드 내 람다식 적용' 방식은 Js 에서도, 그리고 Java 를 이용하는 springBoot 내부에서도
