...
//        int age = scanner.nextInt();    // 전에는 여기에 바로 작성해서 넣었는데,
        // 생각해보면 여기 부분에 음수값이나 200초과 정수를 집어넣을 수 있습니다.
        // 혹은 double 자료형을 넣을수도 있겠네요.
        ...
        } catch (InputMismatchException e) {    // Scanner 사용했는데 변수의 자료형과 일치하지 않을 때 적용됨 "스무살", 20.5가 동일한 예외 발생
